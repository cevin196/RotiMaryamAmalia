    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('city.store')}}" method="POST">
                ...
                <input type="text" name="name" class="form-control form-group" id="name" placeholder="Contoh: Yogyakarta">
                @error('name')
                ...
                <input type="number" name="shipping_cost" class="form-control form-group" id="shipingCost" placeholder="Contoh: Yogyakarta">
                @error('shipping_cost')
                    <span class="text-danger">
                        {{ $message }}
                    </span>
